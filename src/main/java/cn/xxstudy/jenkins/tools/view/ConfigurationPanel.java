...
import cn.xxstudy.jenkins.tools.DoubleClickAction;
import cn.xxstudy.jenkins.tools.JenkinsAppSettings;
import cn.xxstudy.jenkins.tools.JenkinsSettings;
import cn.xxstudy.jenkins.tools.exception.AuthenticationException;
import cn.xxstudy.jenkins.tools.exception.ConfigurationException;
import cn.xxstudy.jenkins.tools.logic.ConfigurationValidator;
...
import cn.xxstudy.jenkins.tools.view.annotation.FormValidator;
import cn.xxstudy.jenkins.tools.view.annotation.GuiField;
import cn.xxstudy.jenkins.tools.view.validator.NotNullValidator;
import cn.xxstudy.jenkins.tools.view.validator.PositiveIntegerValidator;
import cn.xxstudy.jenkins.tools.view.validator.UrlValidator;
...
import static cn.xxstudy.jenkins.tools.view.validator.ValidatorTypeEnum.POSITIVE_INTEGER;
import static cn.xxstudy.jenkins.tools.view.validator.ValidatorTypeEnum.URL;
...
public class ConfigurationPanel {
    ...
    private JTextField filterProjects;
    ...
    public ConfigurationPanel(final Project project) {
        ...
        filterProjects.setName("filterProject");
    ...
    public boolean isModified(JenkinsAppSettings jenkinsAppSettings, JenkinsSettings jenkinsSettings) {
        ...
        boolean isFilterProjectsChanged = !getFilterProjects().equalsIgnoreCase(jenkinsAppSettings.getFilterProjects());
    ...
    public void applyConfigurationData(JenkinsAppSettings jenkinsAppSettings, JenkinsSettings jenkinsSettings) throws ConfigurationException {
        ...
        jenkinsAppSettings.setFilterProjects(getFilterProjects());
    ...
    public void loadConfigurationData(JenkinsAppSettings jenkinsAppSettings, JenkinsSettings jenkinsSettings) {
        ...
        filterProjects.setText(jenkinsAppSettings.getFilterProjects());
    ...
    private String getFilterProjects() {
